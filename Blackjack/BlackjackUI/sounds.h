...
#define PlaySoundOnce(sampleNumber) al_play_sample_instance(Sounds::GetSound(sampleNumber));
#define PlaySoundLoop(sampleNumber) al_play_sample_instance(Sounds::GetSound(sampleNumber, ALLEGRO_PLAYMODE_LOOP));
#define PlaySoundOnceS(sampleNumber, speed) al_play_sample_instance(Sounds::GetSound(sampleNumber, ALLEGRO_PLAYMODE_ONCE, speed));
#define PlaySoundLoopS(sampleNumber, speed) al_play_sample_instance(Sounds::GetSound(sampleNumber, ALLEGRO_PLAYMODE_LOOP, speed));
